...
public class AskActionTest {
    ...
    public void testAsk() {
        ...
        tropo.ask(Key.CHOICES("[1 DIGIT]"), Key.SAY(new Say("Please say a digit")), Key.NAME("foo"), Key.BARGEIN(true), Key.TIMEOUT(30.0f), Key.REQUIRED(true));
    ...
    public void testAskWithSensitivity() {
        ...
        Tropo tropo = new Tropo();
        tropo.ask(Key.CHOICES("[1 DIGIT]"), Key.SAY(new Say("Please say a digit")), Key.NAME("foo"), Key.BARGEIN(true), Key.TIMEOUT(30.0f), Key.SENSITIVITY(30.1f), Key.REQUIRED(true));
    ...
    public void testNewAskWithSayAndOnBlocks() {
      ...
      Tropo tropo = new Tropo();
      tropo.ask(Key.NAME("foo"), Key.BARGEIN(true), Key.TIMEOUT(30.0f), Key.REQUIRED(true), Key.SAY(new Say("Please say your account number")), Key.CHOICES("[5 DIGITS]"));
    ...
    public void testFailsAskWithNoChoicesValue() {
        ...
        Tropo tropo = new Tropo();
        try {
            tropo.ask(Key.NAME("foo"), Key.CHOICES(new Choices(null)), Key.SAY(new Say("[1 DIGIT]")), Key.BARGEIN(true), Key.TIMEOUT(30.0f), Key.REQUIRED(true));
            fail("Expected exception in test");
        }
        catch (TropoException te) {
    ...
    public void testFailsAskWithNoChoicesValue1() {
        ...
        Tropo tropo = new Tropo();
        try {
            tropo.ask(Key.NAME("foo"), Key.CHOICES(new Choices("")), Key.SAY(new Say("[1 DIGIT]")), Key.BARGEIN(true), Key.TIMEOUT(30.0f), Key.REQUIRED(true));
            fail("Expected exception in test");
        }
        catch (TropoException te) {
            assertEquals(te.getMessage(), "Missing required property: value of Choices");
    ...
    public void testFailsAskWithNoSayValue() {
        ...
        Tropo tropo = new Tropo();
        try {
            tropo.ask(Key.NAME("foo"), Key.CHOICES("Please say a digit"), Key.SAY(new Say(null)), Key.BARGEIN(true), Key.TIMEOUT(30.0f), Key.REQUIRED(true));
            fail("Expected exception in test");
        }
        catch (TropoException te) {
    ...
    public void testFailsAskWithNoSayValue1() {
        ...
        Tropo tropo = new Tropo();
        try {
            tropo.ask(Key.NAME("foo"), Key.CHOICES("Please say a digit"), Key.SAY(new Say("")), Key.BARGEIN(true), Key.TIMEOUT(30.0f), Key.REQUIRED(true));
            fail("Expected exception in test");
        }
        catch (TropoException te) {
            assertEquals(te.getMessage(), "Missing required property: value of Say");
    ...
    public void testAllowSignals() {
        ...
        Tropo tropo = new Tropo();
        tropo.ask(Key.CHOICES("[1 DIGIT]"), Key.SAY(new Say("Please say a digit")), Key.NAME("foo"), Key.BARGEIN(true), Key.TIMEOUT(30.0f), Key.REQUIRED(true), Key.ALLOW_SIGNALS("exit", "stopHold"));
    ...
    public void testNewAllParameters() {
      ...
      tropo.ask(Key.CHOICES(new Choices("[4 DIGITS]", Mode.DTMF, "*")), Key.ALLOW_SIGNALS("exit", "quit"),
          ...
          Key.SAY(new Say("Sorry, I did not hear anything.", "timeout"),
